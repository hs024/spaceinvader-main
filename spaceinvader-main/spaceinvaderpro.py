...
##################################################################33#####3
#enemy
listofenemyimg=["enemy2.png","enemy4.png","enemy5.png"]
enemyimg=[]
enemyy=[]
enemyx=[]
enemyx_change=[]
...
def changelevel():
    ...
    overtext=overfont.render("PRESS Enter ",True,(255,255,255))
    screen.blit(overtext,(160,190))
while yes:
    screen.blit(background,(0,0))# background
    for event in pygame.event.get():
    ...
    changelevel()
level_value+=1
background3=pygame.image.load("bg2.png") 
listofenemyimg.remove("enemy2.png")
listofenemyimg.remove("enemy4.png")
listofenemyimg.remove("enemy5.png")
listofenemyimg=["enemy1.png","enemy3.png","enemy4.png"]
enemy_health=[]
while run2:
    #first thing to do fill color
    # screen.fill((130,128,150))#it not update it fill
    screen.blit(background3,(0,0))# background
    #background slow down the speed of palyer so we have to increase the value of change
    #event for closing
    for event in pygame.event.get():
        if event.type==pygame.QUIT:
...
background2=pygame.image.load("bg3.png")

while running:
    screen.blit(background2,(0,0))# background
    #background slow down the speed of palyer so we have to increase the value of change
    #event for closing
    for event in pygame.event.get():
        if event.type==pygame.QUIT:
